...
export default function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/admissions" element={<ProtectedPage roles={["admin", "superadmin", "admission"]}><AdmissionsPage /></ProtectedPage>} />
      <Route path="/my-profile" element={<ProtectedPage roles={["student", "parent"]}><StudentProfile /></ProtectedPage>} />
